...
class passchk {
    ...
    var $min_days_valid = 31;
    var $min_days_labels = '1 month';
    ...
    private function getEntropyArray(){
        ...
        $entropyAry[$i++] = array('days' => $this->min_days_valid, 'time_to_crack' => '1.57 seconds', 'valid' => $this->min_days_labels);
        $entropyAry[$i++] = array('days' => $this->min_days_valid, 'time_to_crack' => '3.14 seconds', 'valid' => $this->min_days_labels);
        $entropyAry[$i++] = array('days' => $this->min_days_valid, 'time_to_crack' => '6.28 seconds', 'valid' => $this->min_days_labels);
        $entropyAry[$i++] = array('days' => $this->min_days_valid, 'time_to_crack' => '12.6 seconds', 'valid' => $this->min_days_labels);
        $entropyAry[$i++] = array('days' => $this->min_days_valid, 'time_to_crack' => '25 seconds', 'valid' => $this->min_days_labels);
        $entropyAry[$i++] = array('days' => $this->min_days_valid, 'time_to_crack' => '50 seconds', 'valid' => $this->min_days_labels);
        $entropyAry[$i++] = array('days' => $this->min_days_valid, 'time_to_crack' => '2 minutes', 'valid' => $this->min_days_labels);
        $entropyAry[$i++] = array('days' => $this->min_days_valid, 'time_to_crack' => '3 minutes', 'valid' => $this->min_days_labels);
        $entropyAry[$i++] = array('days' => $this->min_days_valid, 'time_to_crack' => '7 minutes', 'valid' => $this->min_days_labels);
        $entropyAry[$i++] = array('days' => $this->min_days_valid, 'time_to_crack' => '13 minutes', 'valid' => $this->min_days_labels);
        $entropyAry[$i++] = array('days' => $this->min_days_valid, 'time_to_crack' => '27 minutes', 'valid' => $this->min_days_labels);
        $entropyAry[$i++] = array('days' => $this->min_days_valid, 'time_to_crack' => '54 minutes', 'valid' => $this->min_days_labels);
        $entropyAry[$i++] = array('days' => $this->min_days_valid, 'time_to_crack' => '2 hours', 'valid' => $this->min_days_labels);
        $entropyAry[$i++] = array('days' => $this->min_days_valid, 'time_to_crack' => '4 hours', 'valid' => $this->min_days_labels);
        $entropyAry[$i++] = array('days' => $this->min_days_valid, 'time_to_crack' => '7 hours', 'valid' => $this->min_days_labels);
        $entropyAry[$i++] = array('days' => $this->min_days_valid, 'time_to_crack' => '14 hours', 'valid' => $this->min_days_labels);
        $entropyAry[$i++] = array('days' => $this->min_days_valid, 'time_to_crack' => '1 day', 'valid' => $this->min_days_labels);
        $entropyAry[$i++] = array('days' => $this->min_days_valid, 'time_to_crack' => '2 days', 'valid' => $this->min_days_labels);
        $entropyAry[$i++] = array('days' => $this->min_days_valid, 'time_to_crack' => '5 days', 'valid' => $this->min_days_labels);
        $entropyAry[$i++] = array('days' => $this->min_days_valid, 'time_to_crack' => '1 week', 'valid' => $this->min_days_labels);
        $entropyAry[$i++] = array('days' => $this->min_days_valid, 'time_to_crack' => '3 weeks', 'valid' => $this->min_days_labels);
